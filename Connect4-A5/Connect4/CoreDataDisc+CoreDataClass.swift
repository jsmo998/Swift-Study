...
{
    static func save(positions: [(row: Int, column: Int)], index offset: Int = 1, winningPositions: [(row: Int, column: Int)] = [(Int, Int)](), in managedContext: NSManagedObjectContext) -> [CoreDataDisc]? {
